...
export const getFeeType = (mode: Mode, fee: Fee) => {
	if (mode == Mode.Development) {
		return `0x800d280a8c03db824964d49e76fc8504c10c2d63b81c962af287e1157f15c920::${fee
			.toString()
			.toLowerCase()}::FEE${fee.toString().toUpperCase()}`;
	} else {
		return `0x84d1ad43e95e9833670fcdb2f2d9fb7618fe1827e3908f2c2bb842f3dccb80af::${fee
			.toString()
			.toLowerCase()}::FEE${fee.toString().toUpperCase()}`;
	}
};
